...
## Project Structure
    ...
    ├── tst_branch_deploy_125  # Django project configurations
...
1. Clone this repo and `cd tst_branch_deploy_125`
...
2. Clone this repo and `cd tst_branch_deploy_125`
